...
- **Play** intents are structured as follows:  "Play [artist, album, song or playlist] [

- "Play artist Pink Floyd

sare used to call up the app for Google Home or Google Assistant and prepare for explicit intents.
- "Hey google, talk to LMS Controls"
